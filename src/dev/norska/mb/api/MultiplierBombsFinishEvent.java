...
public class MultiplierBombsFinishEvent extends Event implements Cancellable{

    private final Player player;
    private final MultiplierBombItem multiplierBombItem;
    private boolean isCancelled;

    public MultiplierBombsFinishEvent(Player player, MultiplierBombItem multiplierBombItem) {
        this.player = player;
